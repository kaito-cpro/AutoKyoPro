...
tips:
  You can do similar things with shell: e.g. `for f in test/*.in ; do echo $f ; diff <(.\\a.exe < $f) ${f/.in/.out} ; done`
''')
    subparser.add_argument('-c', '--command', default='.\\a.exe', help='your solution to be tested. (default: ".\\a.exe")')
...
tips:
  You can do similar things with shell: e.g. `for f in test/*.in ; do .\\a.exe < $f > ${f/.in/.out} ; done`
''')
    subparser.add_argument('-c', '--command', default='.\\a.exe', help='your solution to be tested. (default: ".\\a.exe")')
    subparser.add_argument('-f', '--format', default='%s.%e', help='a format string to recognize the relationship of test cases. (default: "%%s.%%e")')
    subparser.add_argument('-d', '--directory', type=pathlib.Path, default=pathlib.Path('test'), help='a directory name for test cases (default: test/)')
